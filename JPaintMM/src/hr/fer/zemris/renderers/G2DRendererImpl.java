...
public class G2DRendererImpl implements Renderer {
    ...
    @Override
    public void drawLine(hr.fer.zemris.util.Point s, hr.fer.zemris.util.Point e) {
        g2d.setColor(Color.BLUE);
        g2d.drawLine(s.getX(), s.getY(), e.getX(), e.getY());
    }

    @Override
    public void fillPolygon(hr.fer.zemris.util.Point[] points) {
